 ...
 */
export async function realPath(thePath) {
    return fs.promises.realpath(thePath);
}
export function realPathSync(thePath) {
 ...
 */
export async function pathExists(thePath) {
    try {
...
export function pathExistsSync(thePath) {
    return fs.statSync(thePath) ? true : false;
}
export async function pathTimes(thePath) {
...
export function pathTimesSync(thePath) {
 ...
 */
export async function fileSize(thePath) {
    return (await fs.promises.stat(thePath)).size;
}
export function fileSizeSync(thePath) {
 ...
 * @return promise to provide `true` or `false`
 */
export async function isFile(thePath) {
    try {
...
export function isFileSync(thePath) {
 ...
 * @return promise to provide `true` or `false`
 */
export async function isDirectory(thePath) {
    try {
...
export function isDirectorySync(thePath) {
 ...
 * @return promise to provide `true` or `false`
 */
export async function isLink(thePath) {
    try {
...
export function isLinkSync(thePath) {
 ...
 */
export async function mkdirs(thePath) {
...
export function mkdirsSync(thePath) {
    const p = path.normalize(path.resolve(process.cwd(), thePath));
 ...
 */
export async function readDir(thePath) {
    const p = await realPath(thePath);
    try {
...
export function readDirSync(thePath) {
    const p = realPathSync(thePath);
 ...
 */
export function readFile(thePath, isText = true) {
...
export function readFileSync(thePath, isText = true) {
 ...
 * @return promise to provide file content.
 */
export async function readTextFile(thePath) {
...
export function readTextFileSync(thePath) {
 ...
 * @return promise to provide file content.
 */
export async function readJsonFile(thePath) {
    const data = await readFile(thePath, true);
    return (typeof data === 'string') ? JSON.parse(data) : data;
}
export function readJsonFileSync(thePath) {
 ...
 */
export async function writeFile(thePath, content, isText = true) {
 ...
 */
export function writeFileSync(thePath, content, isText = true) {
    const encoding = isText ? 'utf8' : 'binary';
 ...
 * @return promise to provide the file name if successful.
 */
export async function writeStream(thePath, content) {
    return await new Promise((resolve, reject) => {
 ...
 * @return promise to provide the file name if successful.
 */
export async function writeTextFile(thePath, content) {
 ...
 * @return the file name if successful.
 */
export function writeTextFileSync(thePath, content) {
 ...
 * @return promise to provide the file name if successful.
 */
export async function writeJsonFile(thePath, obj) {
 ...
 * @return the file name if successful.
 */
export function writeJsonFileSync(thePath, obj) {
 ...
 */
export async function appendFile(thePath, content, isText = true) {
    const encoding = isText ? 'utf8' : { encoding: null };
    await mkdirs(path.dirname(thePath));
    const isFile = isFileSync(thePath);
    if (!isFile)
        await writeTextFile(thePath, '');
...
export function appendFileSync(thePath, content, isText = true) {
    const encoding = isText ? 'utf8' : { encoding: null };
    mkdirsSync(path.dirname(thePath));
 ...
 */
export async function remove(thePath) {
...
export function removeSync(thePath) {
    const dir = isDirectorySync(thePath);
