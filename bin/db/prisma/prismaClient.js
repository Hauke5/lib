 ...
 * @throws
 */
export async function getDBPrisma(database, requiredRoles, createPrisma) {
    ...
    if (!permissions.fulfilled) {
        ...
        return globalPrisma(database, createPrisma);
    }
}
/**
 ...
 */
function globalPrisma(database, createPrisma) {
    const prismaGlobal = serverState(PRISMA_GLOBAL);
